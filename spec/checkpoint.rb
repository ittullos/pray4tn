...
describe Checkpoint do
  ...
  describe 'New checkpoint -' do
    ...
    context 'Checkpoint Types -' do
      %w[heartbeat, stop, prayer].each_with_index do |type, _i|
        context "#{type} -" do
  ...
  describe 'last_prayer_name -' do
    ...
    let(:resident1) do
      UserResident.new(name: 'resident1', address: 'address 1', user_id: user.email, match_key: 'klfsdlfs;')
    end
    let(:prayer) do
